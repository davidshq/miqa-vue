import vtkColorMaps from '@kitware/vtk.js/Sources/Rendering/Core/ColorTransferFunction/ColorMaps';
...
const ParaView = createGroup('ParaView', [
    '2hot',
...
const others = createGroup('Others', [
